...
class BarMovementGenome(Genome):
    def __init__(self, currency_pair: str, time_frame: str, year: int) -> None:
        super().__init__(currency_pair, time_frame, year, BarMovement())
    ...
    def _initialize_features(self) -> Dict[str, GeneticFeature]:
        ...
        pip_movement_atr_multiplier_feature = GeneticFeature([1.0, 1.5, 2.0, 2.5, 3.0])
        lookback_feature = GeneticFeature([6, 12, 24])
        ...
        feature_dictionary = {'ma_key': ma_key_feature, 'invert': invert_feature, 'use_tsl': use_tsl_feature,
                              ...
                              'pip_movement_atr_multiplier': pip_movement_atr_multiplier_feature,
