...
class TechnicalIndicators(object):
    ...
    @staticmethod
    def format_data_for_transformer(df: pd.DataFrame) -> pd.DataFrame:
        formatted_df = df.copy()
        ...
        # Time
        formatted_df['day'] = formatted_df['Date'].dt.day
        formatted_df['hour'] = formatted_df['Date'].dt.hour
        formatted_df['minute'] = formatted_df['Date'].dt.minute
